...
class StoreRevisiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // File harus melewati endpoint upload terlebih dahulu; token session mencegah bypass UI.
            'lampiran' => ['nullable', 'file', 'mimes:pdf', 'max:'.$maxKb],
            'revision_upload_token' => ['required', 'string'],
        ];
    }
